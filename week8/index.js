...
//app = express();
const MONGO_URI = 'mongodb+srv://admin:HDXQj2IwRGQwKYpI@cluster0.srrnilu.mongodb.net/week8';
...
doc1
 ...
 person_doc.find({})
 //finding all the documents in the collection person_doc.find(0)
// find all users
.sort({Salary: 1})
...
.exec()
// execute the query
.then(docs => 1 {console.log("showing age greater than 15",givenage)docs.forEach(function(Doc) {console.log(Doc,age, Doc. name);
})
})
.catch(err => {
console.error(er)})